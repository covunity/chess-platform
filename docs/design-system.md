...
**Read this file before any UI/frontend task.**
...
### Logo Mark
`.logo-mark`: chess-board pattern icon (CSS gradient, 22×22px, border-radius 5px) + "Covunity" in Newsreader serif 20px.
