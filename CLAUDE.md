# Covunity Chess Course Platform — CLAUDE.md
...
| D-22 | Shapes attach to **nodes** in the variation tree, not to board positions; stored and round-tripped via structured PGN comments (`[Covunity:v1]{...}`). |
