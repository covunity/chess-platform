...
export default function PuzzleEditorPanel({
  ...
  const sideButtonStyle = (selected: boolean): React.CSSProperties => ({
    ...
    color: selected ? 'var(--on-ink-1)' : 'var(--ink-1)',
    fontWeight: 500,
    fontSize: 13,
    cursor: 'pointer',
  })
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                color: currentPurpose === null ? 'var(--on-ink-1)' : 'var(--ink-2)',
                fontSize: 12.5,
                fontWeight: 500,
                cursor: 'pointer',
              }}
            ...
            <button
              ...
              style={{
                ...
                color: currentPurpose === 'correct' ? 'var(--on-ink-1)' : 'var(--ink-2)',
                fontSize: 12.5,
                fontWeight: 500,
                cursor: 'pointer',
              }}
            ...
            <button
              ...
              style={{
                ...
                color: currentPurpose === 'mistake' ? 'var(--on-ink-1)' : 'var(--ink-2)',
                fontSize: 12.5,
                fontWeight: 500,
                cursor: 'pointer',
              }}
