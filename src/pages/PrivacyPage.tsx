  ...
  return (
    <main data-testid="privacy-page" className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="prose" style={{ color: 'var(--ink-2)', lineHeight: 1.75, fontSize: 15 }}>
        <p>
          Gambitly (&ldquo;chúng tôi&rdquo;, &ldquo;nền tảng&rdquo;) cam kết bảo vệ quyền riêng tư của bạn.
          Chính sách này giải thích cách chúng tôi thu thập, sử dụng và bảo vệ thông tin cá nhân khi bạn
          sử dụng trang web và dịch vụ của Gambitly.
        </p>
        ...
        <ul style={{ paddingLeft: 20, listStyleType: 'disc' }}>
          <li>Cung cấp, duy trì và cải thiện dịch vụ Gambitly.</li>
        ...
        <p>
          Gambitly sử dụng localStorage để lưu phiên đăng nhập và tùy chọn giao diện.
        ...
        <p>
          Gambitly không hướng đến trẻ em dưới 13 tuổi. Nếu phát hiện tài khoản thuộc về trẻ em dưới 13 tuổi,
