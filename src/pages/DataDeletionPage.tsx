  ...
  return (
    <main data-testid="data-deletion-page" className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="prose" style={{ color: 'var(--ink-2)', lineHeight: 1.75, fontSize: 15 }}>
        <p>
          Counity tôn trọng quyền kiểm soát dữ liệu của bạn. Trang này hướng dẫn cách yêu cầu
        ...
        <ol style={{ paddingLeft: 20 }}>
          ...
          <li>Sử dụng địa chỉ email đã đăng ký tài khoản Counity.</li>
        ...
        <ol style={{ paddingLeft: 20 }}>
          ...
          <li>Tìm <strong>Counity</strong> trong danh sách.</li>
          <li>Nhấn <strong>Xóa</strong> &rarr; chọn <strong>&ldquo;Xóa tất cả bài viết, ảnh và video trên Counity&rdquo;</strong>.</li>
          <li>Counity sẽ nhận được thông báo và tiến hành xóa dữ liệu của bạn.</li>
        </ol>
